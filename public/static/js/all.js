...
/* harmony import */ var _modules_customFront__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./modules/customFront */ "./resources/assets/js--sources/modules/customFront.js");
...
jquery__WEBPACK_IMPORTED_MODULE_0___default()('.btns button').click(function (e) {
  e.preventDefault();
  var form = jquery__WEBPACK_IMPORTED_MODULE_0___default()('#filter-form');
...
//прайс
jquery__WEBPACK_IMPORTED_MODULE_0___default()('#get-price form').submit(function (e) {
  e.preventDefault();
  ...
  sendAjax(url, data, function (json) {
    if (typeof json.errors !== 'undefined') {
      ...
      resetForm(form);
      jquery__WEBPACK_IMPORTED_MODULE_0___default()('.carousel__button.is-close').click();
      (0,_popups__WEBPACK_IMPORTED_MODULE_1__.showSuccessDialog)({
        title: 'Успешно!',
...
//перезвонить
jquery__WEBPACK_IMPORTED_MODULE_0___default()('#callback form').submit(function (e) {
  e.preventDefault();
  var form = jquery__WEBPACK_IMPORTED_MODULE_0___default()(this);
  var data = form.serialize();
  var url = form.attr('action');
...
//отзыв
jquery__WEBPACK_IMPORTED_MODULE_0___default()('.s-callback__form').submit(function (e) {
  e.preventDefault();
  var form = jquery__WEBPACK_IMPORTED_MODULE_0___default()(this);
  var data = form.serialize();
  var url = form.attr('action');
...
//расчет цены
jquery__WEBPACK_IMPORTED_MODULE_0___default()('#calc form').submit(function (e) {
  e.preventDefault();
  var form = jquery__WEBPACK_IMPORTED_MODULE_0___default()(this);
  var text = jquery__WEBPACK_IMPORTED_MODULE_0___default()('#calc .popup__label').text();
...
_fancyapps_ui__WEBPACK_IMPORTED_MODULE_0__.Fancybox.bind('[data-request]', {
  mainClass: 'popup--custom',
  template: {
    closeButton: closeBtn
  },
  ...
  on: {
    reveal: function reveal(e, trigger) {
      var popup = e.$container;
      var label = trigger.label;
      if (popup && label) {
        var popupLabel = popup.querySelector('.popup__label');
        var popupName = popup.querySelector('.popup__name');
        popupLabel.textContent = label;
        popupName.value = label;
      }
    },
    close: function close(e, trigger) {
      var popup = e.$container;
      var label = trigger.label;
      if (popup && label) {
        var popupLabel = popup.querySelector('.popup__label');
...
var showSuccessDialog = function showSuccessDialog(_ref) {
  ...
  _fancyapps_ui__WEBPACK_IMPORTED_MODULE_0__.Fancybox.show([{
    ...
    on: {
      reveal: function reveal(e, trigger) {
        var popup = e.$container;
        if (popup) {
          var popupTitle = popup.querySelector('[data-custom-title]');
          var popupBody = popup.querySelector('[data-custom-label]');
