    ...
    <div class="prod-card__view">
        <div class="prod-card__utils">
            <div class="prod-card__utils-item">
                ...
                <button class="utils-btn btn-reset" type="button" aria-label="Добавить к сравнению" data-compare>
            ...
            <div class="prod-card__utils-item">
                <!-- .is-active — active color state-->
                <button class="utils-btn btn-reset" type="button" aria-label="Добавить в избранное" data-favorites>
