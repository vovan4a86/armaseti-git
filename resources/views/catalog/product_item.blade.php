                ...
                <div class="prod-card__wrapper swiper-wrapper">
                    @foreach($product->images as $image)
                        <div class="prod-card__slide swiper-slide">
                            <picture>
                                <img class="prod-card__img" src="{{ $image->thumb(2, $product->catalog->slug) }}"
        ...
        @else
            <div class="prod-card__slider swiper-slide" data-card-slider="data-card-slider">
                <div class="prod-card__wrapper swiper-wrapper">
                    <div class="prod-card__slide swiper-slide">
                        <picture>
                            <img class="prod-card__img" src="{{ $product->catalog->image ?
                                \Fanky\Admin\Models\Catalog::UPLOAD_URL . $product->catalog->image : \Fanky\Admin\Models\Product::NO_IMAGE }}"
                                 width="277" height="181" alt="{{ $product->name }}" loading="lazy"/>
                        </picture>
                    </div>
                </div>
