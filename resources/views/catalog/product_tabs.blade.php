<div class="prod__tabs">
    <div class="prod-tabs tabs" data-tabs="data-tabs">
        ...
        <div class="prod-tabs__nav tabs__nav">
            ...
            <div class="prod-tabs__link tabs__link" data-open="Отзывы">Отзывы</div>
        </div>
        <!--._views.tabs__views-->
        <div class="prod-tabs__views tabs__views">
                                ...
                                <div class="s-feat__grid s-feat__grid--small">
                                    <div class="s-feat__item">
                                        <div class="s-feat__icon lazy"
                                             data-bg="/static/images/common/feat-1.svg"></div>
                                        <div class="s-feat__title">Надёжность конструкции</div>
                                    </div>
                                    <div class="s-feat__item">
                                        <div class="s-feat__icon lazy"
                                             data-bg="/static/images/common/feat-2.svg"></div>
                                        <div class="s-feat__title">Простота использования</div>
                                    </div>
                                    <div class="s-feat__item">
                                        <div class="s-feat__icon lazy"
                                             data-bg="/static/images/common/feat-4.svg"></div>
                                        <div class="s-feat__title">Лёгкость монтажа</div>
                                    </div>
                                    <div class="s-feat__item">
                                        <div class="s-feat__icon lazy"
                                             data-bg="/static/images/common/feat-3.svg"></div>
                                        <div class="s-feat__title">Плавная работа</div>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="b-docs__item">
                            <a class="b-docs__view" href="{{ $doc->fileSrc($product->catalog->slug) }}"
                               ...
                               data-type="pdf" title="Сертификат диллера">
                                ...
                                <span class="b-docs__preview">
                                                <img class="b-docs__pic" src="/static/images/common/doc-1.jpg"
                                                     width="127" height="244" alt="{{ $doc->name }}"
                                                     loading="lazy"/>
                                            </span>
                            </a>
            ...
            <!--._view-->
            <div class="prod-tabs__view tabs__view" data-view="Отзывы">
                <div class="b-reviews">
                    <div class="b-reviews__grid">
                        <div class="b-reviews__item">
                            <div class="b-reviews__head">
                                <div class="b-reviews__row">
                                    <div class="b-reviews__avatar">
                                        <span>Н</span>
                                    </div>
                                    <div class="b-reviews__data">
                                        <div class="b-reviews__date">01.09.2023</div>
                                        <div class="b-reviews__name">Николай Морозов</div>
                                    </div>
                                </div>
                            </div>
                            <div class="b-reviews__body text-block">
                                <p>Основная сфера применения клиновых задвижек с твёрдыми затворами —
                                    ЖКХ. Запорными конструкциями оснащают сети тепло — и водоснабжения.
                                    Чаще всего арматуру устанавливают в технологических колодцах.
                                    Устройства используются для отключения аварийных
                                    участков.</p>
                            </div>
                        </div>
                    </div>
